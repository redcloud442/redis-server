...
export const authRouteController = async (c: Context) => {
  try {
...
export const setRouteController = async (c: Context) => {
  try {
...
export const getRouteController = async (c: Context) => {
  try {
...
export const delRouteController = async (c: Context) => {
  try {
    const params = c.req.param();
...
export const incrRouteController = async (c: Context) => {
  try {
    const params = c.req.param();
...
export const expireRouteController = async (c: Context) => {
  try {
    const params = c.req.param();
...
export const pingRouteController = async (c: Context) => {
  try {
...
export const sremRouteController = async (c: Context) => {
  try {
    const params = c.req.param();
...
export const saddRouteController = async (c: Context) => {
  try {
    const params = c.req.param();
