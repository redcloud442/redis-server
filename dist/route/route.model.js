...
export const authRouteModel = async (params) => {
...
export const setRouteModel = async (params) => {
    await redis.set(params.key, params.value);
    return { SET: "OK" };
};
export const getRouteModel = async (params) => {
    const value = await redis.get(params.key);
    return { GET: value };
};
export const delRouteModel = async (params) => {
    const value = await redis.del(params.key);
    return { DEL: value };
};
export const incrRouteModel = async (params) => {
